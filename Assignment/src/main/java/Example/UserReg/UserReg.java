...
public class UserReg {
	...
	public UserReg(String firstname, String lastname, String email, String password, long phone, String checkin, String checkout, String RoomTypename) {
		super();
